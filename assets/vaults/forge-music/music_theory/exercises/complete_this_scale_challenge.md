...
Press **Run** to hear the first four notes of a D major scale. Your task: work out the four notes that complete the octave — then check yourself in [[music_theory/exercises/complete_this_scale_submit]]. New to scales? Start with [[music_theory/scales/scale]].
